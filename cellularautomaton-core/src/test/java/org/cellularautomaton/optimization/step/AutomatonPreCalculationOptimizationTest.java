...
public class AutomatonPreCalculationOptimizationTest extends OptimizationStepTest {

	@Test
	public void testPreCalculation() {
		// create automaton
		...
		class Optimization extends
				...
				AutomatonPreCalculationOptimization<Integer>,
				GenericOptimization<CellularAutomaton<Integer>> {
			@Override
			public void execute() {
				assertTrue(getOwner().isReadyForCalculation());
				executed[0] = true;
			}
		}
